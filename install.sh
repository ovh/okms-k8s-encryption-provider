...
usage() {
  this=$1
  cat <<EOF
$this: download binaries for okms-k8s-encryption-provider

Usage: $this [-b <bindir>] [-d] [<tag>]
  -b sets bindir or installation directory, Defaults to $HOME/.local/bin
  -d turns on debug logging
   <tag> is a tag from
   https://github.com/ovh/okms-k8s-encryption-provider/releases
...
OWNER=ovh
REPO="okms-k8s-encryption-provider"
BINARY=okms-k8s-encryption-provider
FORMAT=zip
OS=$(uname_os)
ARCH=$(uname_arch)
PREFIX="$OWNER/$REPO"
